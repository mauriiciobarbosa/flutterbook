...
class TabBarBottomSample extends StatefulWidget {
  @override
  _TabBarBottomSampleState createState() => _TabBarBottomSampleState();
}

class _TabBarBottomSampleState extends State<TabBarBottomSample>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('TabBar bottom')),
      body: SafeArea(
        child: TabBarView(
